	...
	<div class="row">
		<div class="col-md-4 offset-md-4">
			...
			<form class="form-group" method="POST" action="{{route('productos.update', $producto->id)}}">
				...
				<input type="text" class="form-control" name="prod" autocomplete="off" value="{{$producto->tipo->nombre}}">
				<label for="prod">Proveedor : </label>
				<input type="text" class="form-control" name="prod" autocomplete="off" value="{{$producto->proveedor->nombre}} {{$producto->proveedor->apellido}}">
				<div class="row">
